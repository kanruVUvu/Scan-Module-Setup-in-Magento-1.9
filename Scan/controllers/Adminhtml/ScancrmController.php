...
class Bms_Scan_Adminhtml_ScancrmController extends Mage_Adminhtml_Controller_action
{
	...
	public function editAction() {
		...
		if ($model->getId() || $id == 0) {
			...
			$this->_addContent($this->getLayout()->createBlock('scan/adminhtml_scancrm_edit'))
				->_addLeft($this->getLayout()->createBlock('scan/adminhtml_scancrm_edit_tabs'));
    ...
    {
        $fileName   = 'scan.csv';
        $content    = $this->getLayout()->createBlock('scan/adminhtml_scancrm_grid')
            ->getCsv();
