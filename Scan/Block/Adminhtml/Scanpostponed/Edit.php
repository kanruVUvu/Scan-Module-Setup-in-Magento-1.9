...
class Bms_Scan_Block_Adminhtml_Scanpostponed_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            function toggleEditor() {
                if (tinyMCE.getInstanceById('scanpostponed_content') == null) {
                    tinyMCE.execCommand('mceAddControl', false, 'scanpostponed_content');
                } else {
                    tinyMCE.execCommand('mceRemoveControl', false, 'scanpostponed_content');
                }
            }
    ...
    {
        if( Mage::registry('scanpostponed_data') && Mage::registry('scanpostponed_data')->getId() ) {
            return Mage::helper('scan')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('scanpostponed_data')->getId()));
        } else {
